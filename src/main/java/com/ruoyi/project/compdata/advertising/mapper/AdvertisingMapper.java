package com.ruoyi.project.compdata.advertising.mapper;
...
public interface AdvertisingMapper
{
    ...
    Advertising selectAdvertisingByOnlyCondition(@Param("storeCode")String storeCode,@Param("asin")String asin,@Param("month") String month);
